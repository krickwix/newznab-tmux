...
final class NntmuxDeploymentManifestTest extends TestCase
{
    ...
    public function test_orchestrated_workers_keep_isolated_images_and_backfill_ready(): void
    {
        ...
        foreach ($manifest['items'] as $deployment) {
            ...
            $expectedImage = $name === 'nntmux-worker-backfill'
                ...
                ? ':microservices-pods-20260714-current-forward-v153@sha256:5b1970082c6702bb96f146adf238e224efdb101dda3fbffdcc22a9e03d970767'
                : (in_array($name, [
    ...
    public function test_active_orchestrator_preserves_nzb_throughput_contract_and_backfill_zero(): void
    {
        ...
        self::assertSame('microservices-pods-20260714-current-forward-v153', $orchestratorBuild);
        self::assertSame(
            'docker.io/krickwix/nntmux:'.$orchestratorBuild.'@sha256:5b1970082c6702bb96f146adf238e224efdb101dda3fbffdcc22a9e03d970767',
            $orchestratorImage,
        );
        self::assertSame(
        ...
        self::assertSame(
            'microservices-pods-20260714-current-forward-v153',
